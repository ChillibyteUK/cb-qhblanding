...
function widgets_init()
{
    ...
    //     'primary_nav' => __('Primary Nav', 'cb-fvenn'),
    // ));

    // register_nav_menus(array(
    //     'footer_menu1' => __('Footer Menu 1', 'cb-fvenn'),
    // ));
    // register_nav_menus(array(
    //     'footer_menu2' => __('Footer Menu 2', 'cb-fvenn'),
    // ));
...
add_filter('gform_progress_bar', function ($progress_bar, $form, $confirmation_message) {
    $progress_bar = str_replace('Step', '', $progress_bar);
    $progress_bar = str_replace(' of ', '/', $progress_bar);
    return $progress_bar;
}, 10, 3);
